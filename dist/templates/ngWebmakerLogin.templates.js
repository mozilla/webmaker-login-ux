...
angular.module("modal-wrapper.html", []).run(["$templateCache", function($templateCache) {
 $templateCache.put("modal-wrapper.html",
  ...
  "<div class=\"webmaker-login-ux modal fade in\" style=\"display: block; z-index: 99999;  url({{loginBgImage}}) no-repeat center\">\n" +
  "  <div class=\"modal-dialog\">\n" +
  "    <div class=\"modal-content\"></div>\n" +
  "  </div>\n" +
  "\n" +
  "  <div class=\"modal-description\">\n" +
  "    <div class=\"vrlogo\" style=\"background: url({{icon}}) left center\"></div>\n" +
  "    <div>\n" +
